  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <div class="jumbotron">
        ...
        <br>
        <p class="lead" align="left"><i>Learned Society Journal</i> requires that all submitting authors connect their ORCID iDs to their manuscript or review submission. Please connect your ORCID iD to start the submission process.</p>
     ...
     <!-- <div class="row-fluid marketing">
      ...
      <div class="footer">
        Want to build your own demo app? <a href="https://github.com/lizkrznarich/orcid-demo-app" target="_blank">Get the code</a>
      </div>
